...
Start with the delivery documents:
...
5. [Final-200 Clean dataset](evaluation-dataset.md)
6. [Reward v3](reward-v3.md)

The old dashboard and pre-TRACE research memo are historical context, not the
source for final metrics.
